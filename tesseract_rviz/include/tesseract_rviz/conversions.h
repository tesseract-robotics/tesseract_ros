...
Ogre::SceneNode* loadLink(Ogre::SceneManager& scene,
                          ...
                          tesseract::scene_graph::Material::ConstPtr visual_material_override = nullptr,
                          tesseract::scene_graph::Material::ConstPtr collision_material_override = nullptr);

Ogre::SceneNode* loadLinkVisuals(Ogre::SceneManager& scene,
                                 tesseract::gui::EntityContainer& entity_container,
                                 const tesseract::scene_graph::Link& link,
                                 tesseract::scene_graph::Material::ConstPtr material_override = nullptr);
