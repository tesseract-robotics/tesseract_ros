...
ROSPlotting::ROSPlotting(std::string root_link = "world", std::string topic_namespace = "tesseract")
...
bool ROSPlotting::init(tesseract::Tesseract::ConstPtr /*thor*/) override
{
  // TODO
}

void ROSPlotting::plotTrajectory(const tesseract_common::JointTrajectory& traj) override
{
  tesseract_msgs::Trajectory msg;
...
void ROSPlotting::plotTrajectory(const tesseract_planning::Instruction& /*instruction*/) override
{
  // TODO
}
...
void ROSPlotting::plotToolPath(const tesseract_planning::Instruction& /*instruction*/) override
{
  // TODO
}
...
void ROSPlotting::plotAxis(const Eigen::Isometry3d& axis, double scale) override
{
  visualization_msgs::MarkerArray msg;
...
void ROSPlotting::clear() override
{
  // Remove old arrows
  marker_counter_ = 0;
  visualization_msgs::MarkerArray msg;
...
void ROSPlotting::waitForInput() override
{
