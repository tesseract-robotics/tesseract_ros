 ...
 */
#ifndef TESSERACT_PLANNING_SERVER_SIMPLE_CARTESIAN_TASKFLOW_H
#define TESSERACT_PLANNING_SERVER_SIMPLE_CARTESIAN_TASKFLOW_H
...
{
tesseract_planning::GraphTaskflow::UPtr createSimpleCartesianTaskflow(
    bool create_seed,
    const SimplePlannerPlanProfileMap& simple_plan_profiles,
    const SimplePlannerCompositeProfileMap& simple_composite_profiles,
    const DescartesPlanProfileMap& descartes_plan_profiles const TrajOptPlanProfileMap& trajopt_plan_profiles,
    const TrajOptCompositeProfileMap& trajopt_composite_profiles);
}

#endif  // TESSERACT_PLANNING_SERVER_SIMPLE_CARTESIAN_TASKFLOW_H
